...
/**
 * <p>ported from: cn.eova.common.utils.web.RequestUtil
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>请求解析工具：参数表/来路/UA/代理 IP/Cookie</li>
 *   <li>【已声明适配】javax.servlet.http.{Cookie,HttpServletRequest} -> jakarta.servlet.http.*</li>
 *   <li>getIp 依次读 X-Forwarded-For / X-Real-IP / getRemoteAddr，分支顺序属契约</li>
 * </ol>
 */
