...
/**
 * <p>ported from: cn.eova.common.utils.string.RSAEncrypt
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>密钥长度固定 {@code KEYSIZE = 1024}</li>
 *   <li>{@code genKeyPair} 会向 {@code filePath} 写 {@code publicKey.keystore}/{@code privateKey.keystore}</li>
 *   <li>各类失败分支的异常文案（中文）属对外契约，不得改写</li>
 *   <li>{@code byteArrayToString} 以空格分隔、小写十六进制</li>
 * </ol>
 */
