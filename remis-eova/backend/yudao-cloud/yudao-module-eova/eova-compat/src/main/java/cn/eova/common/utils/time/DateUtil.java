...
/**
 * <p>ported from: cn.eova.common.utils.time.DateUtil
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>纯 JDK 实现，无 cn.eova / JFinal 依赖</li>
 *   <li>公开常量 {@code formatStr_*} 与 {@code formatStr[]} 属对外契约</li>
 *   <li>{@code getCurrDate()} 为 {@code synchronized} —— 原样保留</li>
