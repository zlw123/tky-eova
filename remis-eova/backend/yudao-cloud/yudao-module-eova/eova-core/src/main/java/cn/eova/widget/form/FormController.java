...
/**
 * <p>ported from: cn.eova.widget.form.FormController
...
public class FormController extends BaseController {
    ...
    /** 当前操作的主对象 **/
    private final EovaRecord record = new EovaRecord();
    ...
    public void doAdd() throws Exception {
        ...
        if (isSucceed && intercept != null) {
            try {
                ArrayList<EovaRecord> records = new ArrayList<EovaRecord>();
                records.add(record);
    ...
    public void diy() throws Exception {
        ...
        // 获取自定义表单信息
        EovaRecord form = EovaGateways.get(Ds.EOVA).findById("eova_form", "code", code);
    ...
    private MetaObject buildFormData(boolean isEdit, AopContext ac) {
        ...
        if (objectCode.equals("eova_object_code") && !x.isNum(pkValue)) {
            ...
            record = EovaGateways.get(object.getDs()).findById(object.getView(), object.getPk(), object.buildPkValue(pkValue));
        }
