...
/**
 * <p>ported from: cn.eova.common.render.Html2PdfRender
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>HTML 转 PDF 下载渲染（旧实现只写出 HTML，转换交由前端/外部）</li>
 *   <li>【已声明适配】Kv -> LegacyKv；com.jfinal.render.{Render,RenderException} -> 接缝</li>
 * </ol>
 */
public class Html2PdfRender extends LegacyRender {
     ...
     * @param kv 模版参数
     */
    public Html2PdfRender(String fileName, String path, LegacyKv kv) {
