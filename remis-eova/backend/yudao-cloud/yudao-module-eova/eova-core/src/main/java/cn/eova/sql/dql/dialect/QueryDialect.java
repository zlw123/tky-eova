...
/**
 * <p>ported from: cn.eova.sql.dql.dialect.QueryDialect
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>查询方言基类（165 行）：把 MetaField 列表翻译为 SQL 片段；依赖 MetaField 的 8 个静态类型常量</li>
 *   <li>宿主依赖仅 fastjson（JSON/JSONArray）与 cn.eova.tools.x —— 【无需任何替换】</li>
 *   <li>天然逐字节 port；MetaField 落地后其阻塞点已消除（原为 SCC 薄边之一）</li>
 * </ol>
 */
/**
