...
/**
 * <p>ported from: cn.eova.meta.api.FormControler
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>API 表单控制器（301 行）</li>
 * </ol>
 */
/**
 * 通用表单持久化逻辑
...
public class FormControler extends BaseController {
    ...
    public void add() throws Exception {
        ...
        EovaRecord record = getJsonToRecord();
            ...
            public boolean run() throws SQLException {
                try {
                    ...
                    if (!x.isEmpty(object.getTable())) {
                        // 剥离虚拟字段
                        EovaRecord t = WidgetManager.peelVirtual(record);
    ...
    public void data() throws Exception {
        ...
        EovaRecord record = sm.meta.getDataByMetaObject(objectCode, pk);
...
//        setAttr("fixed", fixed);
    ...
    private void deleteOrHide(boolean isDel) throws Exception {
        ...
        List<EovaRecord> records = getJsonToRecords("rows");
