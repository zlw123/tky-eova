...
/**
 * <p>ported from: cn.eova.meta.api.TableController
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>API 表格控制器（442 行）</li>
 * </ol>
 */
/**
 * Table
...
//			}
//		}
        renderJson(LegacyRet.ok().set("count", page.getTotalRow()).set("data", page.getList()));
    }
    ...
    public void export() throws Exception {
        ...
        try {
            ...
            LoggerFactory.getLogger(TableController.class).error("导出计算总量异常:" + e.getMessage());
        }
        ...
        try {
            ...
            LoggerFactory.getLogger(TableController.class).error("导出异常:" + e.getMessage());
...
//    }
    ...
    public void edit() throws Exception {
        ...
        boolean isSucceed = EovaGateways.get(object.getDs()).tx(new LegacyIAtom() {
            @Override
