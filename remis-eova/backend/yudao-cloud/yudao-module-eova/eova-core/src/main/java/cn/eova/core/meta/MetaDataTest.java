...
/**
 * <p>ported from: cn.eova.core.meta.MetaDataTest
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>表结构自省手工测试类（283 行）：DriverManager 直连后打印表的列信息</li>
 *   <li>宿主依赖仅 JDK + cn.eova.common.utils.db.DsUtil —— 【无需任何底座替换】</li>
 *   <li>【R16 既有缺陷，逐字保留】类内硬编码明文数据库账号口令</li>
 *   <li>（url=jdbc:mysql://eova-dev-db7:3306/demo、user、password）。</li>
 *   <li>阶段 1 口径：保留既有缺陷、记录不静默修正。凭据轮换为 R16 单独处置项。</li>
 * </ol>
 */
