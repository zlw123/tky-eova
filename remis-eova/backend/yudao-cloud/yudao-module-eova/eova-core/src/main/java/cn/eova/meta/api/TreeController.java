...
/**
 * <p>ported from: cn.eova.meta.api.TreeController
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>API 树控制器（100 行）</li>
 * </ol>
 */
/**
 * Tree组件
...
public class TreeController extends BaseController {
    ...
    public void query() throws Exception {
        ...
        List<EovaRecord> list = EovaGateways.get(object.getDs()).find(selelct + " " + sql, paras);
...
//			});
        ...
        renderJson(LegacyJsonKit.toJson(list));
    }
