...
/**
 * <p>ported from: cn.eova.common.utils.excel.ExceUtil
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>Excel/CSV 导出工具（171 行）：export / exportCsv / createWorkBook</li>
 *   <li>依赖 org.ttzero:eec（EasyExcel 系）—— 版本 0.5.24 取自旧运行期 classpath 实录</li>
 *   <li>【已声明适配】com.jfinal.plugin.activerecord.Record -> cn.eova.db.EovaRecord</li>
 *   <li>样式常量（Fill/PatternType/Styles）与列宽换算属导出契约，不得调整</li>
 * </ol>
 */
/**
 * Excel文件处理
...
public class ExceUtil {
     ...
     * @throws IOException
     */
    public static void export(List<MetaField> fields, List<EovaRecord> data, String filePath) throws IOException {
     ...
     * @throws IOException
     */
    public static void export(List<MetaField> fields, List<EovaRecord> data, OutputStream os) throws IOException {
        Workbook book = createWorkBook(fields, data);
        book.writeTo(os);
    }
     ...
     * @throws IOException
     */
    public static void exportCsv(List<MetaField> fields, List<EovaRecord> data, OutputStream os) throws IOException {
        Workbook book = createWorkBook(fields, data);
        book.saveAsCSV();
        book.writeTo(os);
    }
     ...
     * @throws IOException
     */
    public static Workbook createWorkBook(List<MetaField> fields, List<EovaRecord> data) throws IOException {
