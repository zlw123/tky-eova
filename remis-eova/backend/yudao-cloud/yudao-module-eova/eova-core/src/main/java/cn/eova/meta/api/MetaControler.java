...
/**
 * <p>ported from: cn.eova.meta.api.MetaControler
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>API 元数据控制器（206 行）：对象/字段/表格元数据接口</li>
 * </ol>
 */
/**
 * 元数据处理
...
public class MetaControler extends BaseController {
    ...
    public void table() {
        ...
        LegacyRet ret = LegacyRet.ok().set("object", object).set("fields", fields);
    ...
    public void option() throws Exception {
        ...
        LegacyRet ret = LegacyRet.ok().set("option", option).set("fields", fields);
...
//        LegacyRet ret = LegacyRet.ok().set("data", templateKv);
    ...
    public void add() {
        ...
        LegacyRet ret = getJsonToRet();

        EovaGateways.save(table, new EovaRecord().setColumns(ret));
...
//        EovaRecord record = Json.getJson().parse(json.toJSONString(), EovaRecord.class);
