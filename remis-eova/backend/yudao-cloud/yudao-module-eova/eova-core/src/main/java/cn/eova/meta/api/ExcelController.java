...
/**
 * <p>ported from: cn.eova.meta.api.ExcelController
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>Excel 控制器（161 行）：导出/模板下载</li>
 * </ol>
 */
/**
 * 数据导入
...
public class ExcelController extends BaseController {
    ...
    public void imports() {
        ...
        EovaRecord template = EovaGateways.get(Ds.EOVA).findFirst("select * from eova_import_template where code = ?", code);
    ...
    public void doImport() {
        ...
        EovaGateways.get(Ds.EOVA).save("eova_import", log);
    ...
    public void export() throws Exception {
        ...
        List<EovaRecord> data = EovaGateways.get(object.getDs()).find(String.format("%s %s limit 0, 1000000", select, sql), parmList.toArray());
