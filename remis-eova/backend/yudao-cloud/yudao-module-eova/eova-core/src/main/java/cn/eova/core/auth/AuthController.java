...
/**
 * <p>ported from: cn.eova.core.auth.AuthController
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>权限控制器（344 行）：角色授权、按钮/菜单授权</li>
 *   <li>【已声明适配】Before/Ret/Tx/TxConfig/Db 走既有接缝</li>
 * </ol>
 */
/**
 * 权限管理
...
//        String json = JsonKit.toJson(authed);
    ...
    public void doAuth() {
        ...
        // 批量保存
        EovaGateways.get(Ds.EOVA).batchSave(list, list.size());
