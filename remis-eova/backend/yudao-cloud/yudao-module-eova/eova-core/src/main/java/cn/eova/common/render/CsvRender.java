...
/**
 * <p>ported from: cn.eova.common.render.CsvRender
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>CSV 下载渲染：Content-disposition 附件名 + ExceUtil.exportCsv</li>
 *   <li>【已声明适配】LogKit -> 行内 SLF4J（U2/r333）；Record -> EovaRecord；com.jfinal.render.{Render,RenderException} -> 接缝</li>
 * </ol>
 */
public class CsvRender extends LegacyRender {
    ...
    public CsvRender(List<MetaField> fields, List<EovaRecord> data, String fileName) {
        this.fields = fields;
        this.data = data;
    ...
    public void render() {
        ...
        try {
            ...
            try {
                ...
                LoggerFactory.getLogger(CsvRender.class).error(e.getMessage(), e);
            }
