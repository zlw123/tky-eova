...
/**
 * <p>ported from: cn.eova.aop.MetaObjectIntercept
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>元对象业务拦截器（351 行）：EOVA 元数据驱动业务扩展的核心回调面</li>
 *   <li>【已声明适配 1】com.jfinal.kit.Kv -> cn.eova.compat.jfinal.kit.LegacyKv</li>
 *   <li>方法签名与回调时序属【对外扩展契约】（用户 mod 覆写它们）</li>
 * </ol>
 */
/**
 * <pre>
...
public class MetaObjectIntercept {
     ...
     *     sum += e.getDouble("num");
     * }
     * return new LegacyKv().set("Table的某列", "汇总:(单位/元)").set("Table的某列", sum);
     * </pre>
     */
    public LegacyKv queryFooter(AopContext ac) throws Exception {
        return null;
    }
