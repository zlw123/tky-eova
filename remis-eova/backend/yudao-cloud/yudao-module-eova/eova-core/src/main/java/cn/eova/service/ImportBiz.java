// compile-stub for R4-JAVA ImportBiz; not a ported unit.
// real source: meta-eova/eova/core/src/main/java/cn/eova/service/ImportBiz.java（162 行）
 ...
 *
 * <p><b>已知缺口：</b>导入服务（162 行）：读 Excel 导入、按元数据落库、写导入日志。凡在 stub 期间编译通过、但运行期会走到
