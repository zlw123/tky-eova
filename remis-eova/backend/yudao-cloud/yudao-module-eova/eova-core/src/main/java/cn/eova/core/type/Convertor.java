...
/**
 * <p>ported from: cn.eova.core.type.Convertor
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>数据类型转换器抽象基类（94 行）：把元字段声明映射到 Java 类型并做值转换</li>
 *   <li>【已声明适配】com.jfinal.core.converter.TypeConverter -> LegacyTypeConverter</li>
 *   <li>    （rule() 里的 TypeConverter.me().convert(c, o.toString())）</li>
 *   <li>mapping()/convert()/convertValue() 三个抽象方法与 getJavaType/rule 的语义属契约</li>
 * </ol>
 */
/**
...
public abstract class Convertor {
    ...
    protected Object rule(Object o, Class c) {
        ...
        try {
            return LegacyTypeConverter.me().convert(c, o.toString());
        } catch (Exception e) {
