...
/**
 * <p>ported from: cn.eova.common.utils.db.SqlUtil
 * <br>source revision: meta-eova/eova 1b1d39e7350f7e031b216aad0399fc8cc55dce08
 * <br>本单元为逐行等价 port：文件体与旧实现逐字节一致，仅新增本追溯头。
 * <br><b>刻意保留的既有语义：</b>
 * <ol>
 *   <li>纯字符串/SQL 操作，宿主依赖仅 druid 的 SQL 解析器（可用）</li>
 *   <li>getSequence 仅依赖 EovaDataSource.getDbType 与 EovaConst.SEQ_，不依赖 EovaConfig</li>
 * </ol>
 */
