...
CREATE TABLE `address`  (
  ...
  `full` varchar(255) NULL DEFAULT NULL COMMENT '详细地址',
...
CREATE TABLE `data_money`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `moon` varchar(11) NULL DEFAULT NULL COMMENT '月份',
...
CREATE TABLE `dicts`  (
  ...
  `ext` varchar(255) NULL DEFAULT '' COMMENT '扩展Json',
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `goods_style`  (
  ...
  `code` varchar(20) NOT NULL COMMENT '款号',
  `tag` varchar(2) NULL DEFAULT NULL COMMENT '标签',
  `price` double NOT NULL DEFAULT 0.00 COMMENT '默认价格',
  `cid2` int NULL DEFAULT NULL COMMENT '上级类目',
  `cid` int NULL DEFAULT NULL COMMENT '类目(旧)',
  `cat_id` int NULL DEFAULT NULL COMMENT '类目',
  `cat_name` varchar(30) NULL DEFAULT NULL COMMENT '类目名称',
  `colors` varchar(255) NULL DEFAULT NULL COMMENT '支持颜色',
  `sizes` varchar(255) NULL DEFAULT NULL COMMENT '支持尺码',
  `product_id` int NULL DEFAULT NULL COMMENT '产品',
  `create_uid` int NOT NULL DEFAULT 0 COMMENT '创建人ID',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `location` varchar(100) NULL DEFAULT NULL COMMENT '库位',
  `fabric_id` int NULL DEFAULT NULL COMMENT '面料',
  `tag_id` int NULL DEFAULT NULL COMMENT '吊牌',
  `label_id` varchar(30) NULL DEFAULT NULL COMMENT '标签',
  `unit` varchar(5) NULL DEFAULT NULL COMMENT '单位',
  PRIMARY KEY (`id`),
...
CREATE TABLE `item`  (
  ...
  `info` varchar(1000) NULL DEFAULT NULL COMMENT '介绍',
  `img` varchar(255) NULL DEFAULT NULL COMMENT '物品图片',
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `links`  (
  ...
  `title` varchar(255) NULL DEFAULT NULL COMMENT '小标题',
  `test` varchar(255) NULL DEFAULT NULL COMMENT '测试',
...
CREATE TABLE `my_file`  (
  ...
  `files` varchar(500) NULL DEFAULT '' COMMENT '文件',
  `imgs` varchar(500) NULL DEFAULT '' COMMENT '图片',
  `info` varchar(255) NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`)
);
...
CREATE TABLE `orders`  (
  ...
  `state` int NULL DEFAULT 10 COMMENT '订单状态：10=待支付,20=已支付,30=已发货,40=已收货',
  `money` double NULL DEFAULT 0.00 COMMENT '应付金额',
  `score` double NULL DEFAULT 0.00 COMMENT '消耗积分',
  `memo` varchar(256) NULL DEFAULT '' COMMENT '备注',
  `create_user_id` int NOT NULL COMMENT '创建用户ID',
  `update_user_id` int NOT NULL COMMENT '最后更新用户ID',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
  `is_invoice` tinyint NULL DEFAULT 0 COMMENT '是否开票',
  `additional_info` varchar(1000) NULL DEFAULT NULL COMMENT '订单补充信息(JSON格式)',
  `address` varchar(500) NULL DEFAULT NULL COMMENT '收货地址',
  `consignee` varchar(50) NULL DEFAULT NULL COMMENT '收货人',
  `tel` varchar(20) NULL DEFAULT NULL COMMENT '联系方式',
...
CREATE TABLE `orderss`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '编号',
  `pay_id` int NULL DEFAULT 0 COMMENT '支付ID',
  `state` int NULL DEFAULT 10 COMMENT '订单状态：10=待支付,20=已支付,30=已发货,40=已收货：支付过程的状态标识',
  `money` double NULL DEFAULT 0.00 COMMENT '应付金额',
  `memo` varchar(256) NULL DEFAULT '' COMMENT '备注',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '更新时间',
...
CREATE TABLE `test_info`  (
  ...
  `id_card` varchar(255) NULL DEFAULT NULL COMMENT '身份证图片',
  `update_time` date NULL DEFAULT NULL COMMENT '更新日期',
  `create_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `password` varchar(255) NULL DEFAULT NULL COMMENT '密码',
  `color` varchar(10) NULL DEFAULT NULL COMMENT '颜值',
  `tag` varchar(255) NULL DEFAULT NULL COMMENT '标签',
  `json` varchar(500) NULL DEFAULT NULL COMMENT '配置信息',
  `test1` int NULL DEFAULT NULL,
  `test2` float NULL DEFAULT NULL,
  `test3` double NULL DEFAULT NULL,
  `test4` tinyint(1) NULL DEFAULT NULL,
  `test5` bigint NULL DEFAULT NULL,
...
CREATE TABLE `user_info`  (
  ...
  `status` int NULL DEFAULT 0 COMMENT '状态',
  `nickname` varchar(30) NULL DEFAULT '' COMMENT '昵称',
  `mobile` varchar(11) NULL DEFAULT NULL COMMENT '联系手机',
  `province` int NULL DEFAULT NULL COMMENT '省',
  `city` int NULL DEFAULT NULL COMMENT '市',
  `region` int NULL DEFAULT NULL COMMENT '区',
...
CREATE TABLE `users`  (
  ...
  `login_id` varchar(255) NULL DEFAULT '' COMMENT '登录账户',
  `login_pwd` varchar(255) NULL DEFAULT '' COMMENT '录登密码',
  `nickname` varchar(255) NULL DEFAULT '' COMMENT '昵称',
  `nickname1` varchar(255) NULL DEFAULT '' COMMENT '昵称',
...
CREATE TABLE `users_exp`  (
  ...
  `qq` varchar(255) NULL DEFAULT '' COMMENT 'QQ',
